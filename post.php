              ...
              if(isset($_SESSION['user_role']) && ($_SESSION['user_role'] == 'admin')) {
                ...
                $query = "SELECT * FROM posts WHERE post_id = $the_post_id AND post_status = 'published' ";
                  ...
                  if(mysqli_num_rows($select_all_posts_query) < 1) {
                   echo "There are no posts availiable.";
                 } 
...
<?php  } else { ?>
      ...
      <div class="row">
        <p class="pull-right login-to-post"><a href="/cms/login.php">Login</a> and Like the post</p>
      </div>  
    ...
    <form action="" method="post" role="form">
         <div class="form-group">
           <label for="Author">Author</label>
            <input type="text" name="comment_author" placeholder="Author" class="form-control" name="comment_author">
        </div>        
        
        <div class="form-group">
           <label for="Email">Email</label>
            <input type="email" name="comment_email" placeholder="Email" class="form-control" name="comment_email">
        </div>
